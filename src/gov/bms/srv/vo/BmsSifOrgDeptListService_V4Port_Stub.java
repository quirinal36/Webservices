...
public class BmsSifOrgDeptListService_V4Port_Stub 
     extends weblogic.wsee.jaxrpc.StubImpl
     implements gov.bms.srv.vo.BmsSifOrgDeptListService_V4Port, /**/java.io.Serializable
{

  public BmsSifOrgDeptListService_V4Port_Stub(weblogic.wsee.wsdl.WsdlPort port, 
                        weblogic.wsee.jaxrpc.ServiceImpl service) 
    throws javax.xml.rpc.ServiceException
  {
    super(port, gov.bms.srv.vo.BmsSifOrgDeptListService_V4Port.class, service);
  }
  ...
  public gov.bms.lnk.ini.vo.BmsLnkIniOrgAllDeptLViewRes4VO getAllDeptListView(gov.bms.lnk.ini.vo.BmsLnkIniOrgAllDeptLViewReqVO bmsLnkIniOrgAllDeptLViewReqVO) throws java.rmi.RemoteException {
    ...
    try {
      ...
      return (gov.bms.lnk.ini.vo.BmsLnkIniOrgAllDeptLViewRes4VO)_result;
    } catch (javax.xml.rpc.JAXRPCException _wls_exception) {
      throw new java.rmi.RemoteException(_wls_exception.getMessage(), _wls_exception.getLinkedCause());
    } catch (javax.xml.rpc.soap.SOAPFaultException _wls_exception) {
      throw new java.rmi.RemoteException(_soapFault2String(_wls_exception), _wls_exception);
    ...
    _setProperty(weblogic.wsee.async.AsyncConstants.OPERATION_NAME_PROPERTY,
                 "getAllDeptListView");
    _setProperty(weblogic.wsee.async.AsyncConstants.RETURN_TYPE_PROPERTY, "gov.bms.lnk.ini.vo.BmsLnkIniOrgAllDeptLViewRes4VO");
    _args.add(bmsLnkIniOrgAllDeptLViewReqVO);
  ...
  public gov.bms.lnk.ini.vo.BmsLnkIniOrgUserInfoViewRes5VO getByDeptUserInfoListView(gov.bms.lnk.ini.vo.BmsLnkIniOrgUserInfoViewReqVO bmsLnkIniOrgUserInfoViewReqVO) throws java.rmi.RemoteException {
  ...
  private Object writeReplace() throws java.io.ObjectStreamException {
    java.util.HashMap map = new java.util.HashMap();
            map.put("BmsSifOrgDeptListService_V4Port", "BmsSifOrgDeptListService_V4Port");
            
    return new weblogic.wsee.tools.clientgen.stubgen.StubSerialWrapper(
      "gov.bms.srv.vo.BmsSifOrgDeptListService_V4",
